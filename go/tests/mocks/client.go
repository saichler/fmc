...
func NewFmcClient(baseURL string, httpClient *http.Client) *FmcClient {
	return &FmcClient{baseURL: baseURL, client: httpClient}
}

func (c *FmcClient) Authenticate(user, password string) error {
...
func (c *FmcClient) Get(endpoint string, query string) (string, error) {
	reqURL := c.baseURL + endpoint + "?body=" + url.QueryEscape(query)
...
func (c *FmcClient) Post(endpoint string, data interface{}) (string, error) {
